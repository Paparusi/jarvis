...
description: >
  ...
  Kích hoạt khi user hỏi về chủ đề liên quan đến tìm kiếm tin.
version: 1.0.0
metadata:
  jarvis:
    ...
    usage_count: 3
    priority: 0.6
    mcp_tools: ["web_search", "fetch_url"]
---

# Tìm Kiếm Tin

## Khi nào kích hoạt
Khi user hỏi về tìm kiếm tin hoặc các chủ đề liên quan.
Skill này được tự động tạo từ 3 interactions thành công.

## Tools
Sử dụng: web_search, fetch_url

## Ví dụ trigger
- "Tìm kiếm thông tin trên web được không?"
- "bây giờ tìm kiếm giá vàng trên web được chưa"
